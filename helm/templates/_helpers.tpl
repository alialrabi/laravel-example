...
Common labels
*/}}
{{- define "coverwhale.labels" -}}
helm.sh/chart: {{ include "coverwhale.chart" . }}
{{ include "coverwhale.selectorLabels" . }}
{{- if .Chart.AppVersion }}
...
Selector labels
*/}}
{{- define "coverwhale.selectorLabels" -}}
app.kubernetes.io/name: {{ include "coverwhale.name" . }}
